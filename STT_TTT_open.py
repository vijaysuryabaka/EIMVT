...
def listen_print_loop(responses: object) -> str:
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            print(transcript + '\n')
            trans_text = translator(transcript, detected_language)
            print(trans_text)
...
def translator(source_text, source_language):
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Translate this from {source_language} to English: '{source_text}'"}
        ]
    )
